  ...
  return (
    <div className="space-y-12 animate-fade-in pb-10">
      ...
      <div className="overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0 md:pb-0 no-scrollbar">
        <div className="flex gap-2 md:gap-3 p-1.5 glass-card rounded-2xl w-max border-gray-100/50">
          <button
            onClick={() => setActiveTab('public')}
            className={`px-4 md:px-6 py-2.5 rounded-xl font-black text-[9px] md:text-[10px] uppercase tracking-widest transition-all duration-300 flex items-center gap-2 ${activeTab === 'public'
          ...
          <button
            ...
            className={`px-4 md:px-6 py-2.5 rounded-xl font-black text-[9px] md:text-[10px] uppercase tracking-widest transition-all duration-300 flex items-center gap-2 ${activeTab === 'submit'
              ? 'bg-church-green text-white shadow-premium scale-105'
              : 'text-gray-500 hover:text-church-green'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 md:px-6 py-2.5 rounded-xl font-black text-[9px] md:text-[10px] uppercase tracking-widest transition-all duration-300 flex items-center gap-2 ${activeTab === 'my'
              ? 'bg-church-green text-white shadow-premium scale-105'
              : 'text-gray-500 hover:text-church-green'
              }`}
          >
      ...
      {activeTab === 'submit' ? (
        <div className="max-w-3xl mx-auto w-full group">
          <div className="glass-card p-6 md:p-10 rounded-[2rem] md:rounded-3xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-church-green/5 rounded-full blur-3xl -mr-32 -mt-32"></div>

            <div className="relative z-10">
              <div className="mb-6 md:mb-8">
                <h3 className="text-xl md:text-2xl font-black dark:text-white mb-1 tracking-tighter">Tell Your Miracle</h3>
                <p className="text-gray-500 text-xs md:text-sm font-medium">Your miracle can inspire and strengthen others' faith.</p>
              </div>
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="relative">
                  <textarea
                    ...
                    className="w-full h-40 md:h-48 p-5 md:p-6 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-white/5 outline-none focus:border-church-green transition-all font-serif text-sm md:text-base leading-relaxed italic placeholder-gray-400 resize-none shadow-inner"
                    placeholder="In the beginning of the year, I was facing a challenge..."
                  />
                  <div className="absolute bottom-4 right-4 md:bottom-6 md:right-8 text-gray-300 pointer-events-none">
                    <Quote className="opacity-10 w-6 h-6 md:w-8 md:h-8" />
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-church-green hover:bg-emerald-700 text-white py-3.5 md:py-4 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] shadow-premium hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                >
